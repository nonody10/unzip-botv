...
LABEL org.opencontainers.image.source="https://github.com/orgservice/unzip-bot.git"
LABEL org.opencontainers.image.title="unzip-bot"
LABEL org.opencontainers.image.url="https://github.com/orgservice/unzip-bot"
...
RUN git clone -b v7 --single-branch https://github.com/orgservice/unzip-bot.git /app && \
